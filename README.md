...
The gdx-pay project is a libGDX extension. Current release version is 0.11.2. Please use at least libGDX v1.9.6, robovm 2.3.0 or multi-os-engine v1.3.6.
...
* [gdx-pay-client.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-client/0.11.2/gdx-pay-client-0.11.2-library.jar)
...
* 0.11.2: Bugfix release for #157 (MOE iOS 9), #158 (Robovm GC issue)  
