...
The gdx-pay project is a libGDX extension. Current release version is 0.3.0 (0.4.0 snapshots available
via sonatype).
...
* [gdx-pay.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay/0.3.0/gdx-pay-0.3.0-library.jar)
...
* [gdx-pay-android.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-android/0.3.0/gdx-pay-android-0.3.0-library.jar)
* [gdx-pay-android-openiab.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-android-openiab/0.3.0/gdx-pay-android-openiab-0.3.0-library.jar) (to support GooglePlay, Amazon etc.)
* [gdx-pay-android-ouya.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-android-ouya/0.3.0/gdx-pay-android-ouya-0.3.0-library.jar) (to support OUYA)
* AndroidManifest.xml: 
```
<!--all-->
...
* [gdx-pay-iosrobovm-apple.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-iosrobovm-apple/0.3.0/gdx-pay-iosrobovm-apple-0.3.0-library.jar)
...
* [gdx-pay-desktop-apple.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-desktop-apple/0.3.0/gdx-pay-desktop-apple-0.3.0-library.jar) (to support the Mac App Store): *needs implementation/volunteers wanted!*

In your **GWT project** you use:
* [gdx-pay-gwt-googlewallet.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-gwt-googlewallet/0.3.0/gdx-pay-gwt-googlewallet-0.3.0-library.jar) (to support Google Wallet): *needs implementation/volunteers wanted!*
...
* [gdx-pay.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay/0.3.0/gdx-pay-0.3.0-library.jar) 
* [gdx-pay-server.jar](https://oss.sonatype.org/content/repositories/releases/com/badlogicgames/gdxpay/gdx-pay-server/0.3.0/gdx-pay-server-0.3.0-library.jar) 
